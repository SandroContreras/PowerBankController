...
while True:
    ...
    battery_percentage = BatteryMethods.SOCtable(previous_battery_percent_str, battery_percent_str)							## battery_percentage is an integer
